		...
		<div class="col-lg-3 col-md-4 col-sm-5<?=(isset($arParams['FILTER_HIDE_ON_MOBILE']) && $arParams['FILTER_HIDE_ON_MOBILE'] === 'Y' ? ' d-none d-sm-block' : '')?>">
			...
			if ($isFilter): ?>
				<div class="bx-sidebar-block">
					<?
					$APPLICATION->IncludeComponent("bitrix:catalog.smart.filter", "fullready_filter", array(
				...
				if (!isset($arParams['USE_BIG_DATA']) || $arParams['USE_BIG_DATA'] != 'N')
				{
					...
					<div class="row mb-3">
						<div class="col" data-entity="parent-container">
							...
							<? $APPLICATION->IncludeComponent("bitrix:catalog.section", "fullready_cards", array(
									"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
									"IBLOCK_ID" => $arParams["IBLOCK_ID"],
									"ELEMENT_SORT_FIELD" => $arParams["ELEMENT_SORT_FIELD"],
									"ELEMENT_SORT_ORDER" => $arParams["ELEMENT_SORT_ORDER"],
